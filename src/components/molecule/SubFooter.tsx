import subFooterData from '../../data/data.json';
import type { SubFooterData } from '../../types/datatypes';

const SubFooter = () => {
  const data: SubFooterData = subFooterData;

  return (
    <>
      <div className="subfooter-section-one">
        <div className="subfooter-section-one-email-text">
          <p>{data.emailSection.text}</p>
        </div>
        <div className="subfooter-section-one-input-field">
          <div className="input-field-container">
            <input type="text" placeholder={data.emailSection.placeholder} />
            <p>{data.emailSection.buttonText}</p>
          </div>
        </div>
      </div>
      <div className="subfooter-section-two">
        <div className="subfooter-container-section-two">
          ...
          <div className="sub-footer-text">
            <span>{data.renewableEnergySection.text}</span>
          </div>
        </div>
      </div>
    </>
